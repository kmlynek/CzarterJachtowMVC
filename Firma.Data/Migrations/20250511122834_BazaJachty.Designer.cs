...
namespace Firma.Data.Migrations
{
    ...
    [Migration("20250511122834_BazaJachty")]
    partial class BazaJachty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Firma.Data.Data.Flota.Jacht", b =>
                {
                    ...
                    b.Property<int?>("KategoriaJachtuIdKategorii")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KategoriaJachtuIdKategorii");

                    b.HasIndex("PortIdPortu");
            ...
            modelBuilder.Entity("Firma.Data.Data.Flota.Jacht", b =>
                {
                    b.HasOne("Firma.Data.Data.Flota.KategoriaJachtu", "KategoriaJachtu")
                        .WithMany("Jachty")
                        .HasForeignKey("KategoriaJachtuIdKategorii");

                    b.HasOne("Firma.Data.Data.Flota.Port", "Port")
                        .WithMany("Jachty")
                        .HasForeignKey("PortIdPortu");
